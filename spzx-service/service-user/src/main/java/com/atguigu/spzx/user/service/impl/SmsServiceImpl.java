...
public class SmsServiceImpl implements SmsService {
    ...
    public void sendValidateCode(String phone) {
        ...
        String rsCode = redisTemplate.opsForValue().get(phone);
        if(StringUtils.hasText(rsCode)){
            return;
        }

        //1.生成验证码，一般是4位数字的验证码
        String code = RandomStringUtils.randomNumeric(4);//生成i一个四位数字的随机验证码
//2.把生成的验证码放到redis当中，并且设置失效时间
    ...
    private void sendMessage(String phone, String code) {
        ...
        String method = "POST";
        String appcode = "6268b7533a294131b5ddbb8f44dcdc8c";
